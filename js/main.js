...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiYmx1ZWVjb2NyeXN0YWwiLCJhIjoiY2ptZzdrNDliMjNvaTNrczNzOGZkcWNjcSJ9.pVJ7slFwcV9uqlZFdTkKsA',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  divBot.append(neighborhood);

  const address = document.createElement('p');
  address.innerHTML = restaurant.address;
  divBot.append(address);
...
addMarkersToMap = (restaurants = self.restaurants) => {
  restaurants.forEach(restaurant => {
    ...
    const marker = DBHelper.mapMarkerForRestaurant(restaurant, self.newMap, true);
